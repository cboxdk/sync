        ...
        return [
            ...
            [
                ...
                'indexes' => [
                    ...
                    // A stream position's answer. Unique - a position is answered
                    // once - so a locking read of one that exists locks that row
                    // and nothing around it.
                    ['name' => 'sync_receipts_stream_position', 'unique' => true, 'columns' => ['space', 'replica_id', 'sequence']],
                ],
            ],
            [
                'name' => 'sync_streams',
